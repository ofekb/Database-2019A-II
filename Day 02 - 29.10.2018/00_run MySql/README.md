...
![picture](step10.png)  
* Paste into the new page the following script:
```sql
...
If the creation has been success:
 


Now, click refresh and see the new Schema added:
 

Now, in order to insert data into this DB, we have to paste this script:
#
